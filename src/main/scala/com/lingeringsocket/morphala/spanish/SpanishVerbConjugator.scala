...
object SpanishVerbConjugator
{
  ...
  val STEM_CHANGE_E_TO_I =
    MorphalaJson.wordSet("STEM_CHANGE_E_TO_I")

  val STEM_CHANGE_O_TO_UE =
    MorphalaJson.wordSet("STEM_CHANGE_O_TO_UE")

  val IRREGULAR_REQUIRE_FULL =
    MorphalaJson.wordSet("IRREGULAR_REQUIRE_FULL")

  val STEM_CHANGE_REQUIRE_FULL =
    MorphalaJson.wordSet("STEM_CHANGE_REQUIRE_FULL")

  val IAR_IRREGULAR =
    MorphalaJson.wordSet("IAR_IRREGULAR")
...
abstract class SpanishVerbConjugator(
